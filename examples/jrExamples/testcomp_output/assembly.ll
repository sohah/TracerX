; ModuleID = '/home/soha/git/tracerXMaster/tracerx/examples/jrExamples/testcomp_example.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"b1\00", align 1
@.str1 = private unnamed_addr constant [3 x i8] c"b2\00", align 1
@.str2 = private unnamed_addr constant [7 x i8] c"x !=28\00", align 1
@.str3 = private unnamed_addr constant [76 x i8] c"/home/soha/git/tracerXMaster/tracerx/examples/jrExamples/testcomp_example.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast i32* %b1 to i8*, !dbg !128
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0)), !dbg !128
  %3 = bitcast i32* %b2 to i8*, !dbg !129
  call void @klee_make_symbolic(i8* %3, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0)), !dbg !129
  %4 = load i32* %b1, align 4, !dbg !130
  %5 = icmp eq i32 %4, 1, !dbg !130
  br i1 %5, label %6, label %9, !dbg !130

; <label>:6                                       ; preds = %0
  %7 = load i32* %x, align 4, !dbg !132
  %8 = add nsw i32 %7, 12, !dbg !132
  store i32 %8, i32* %x, align 4, !dbg !132
  br label %9, !dbg !132

; <label>:9                                       ; preds = %6, %0
  %10 = load i32* %b2, align 4, !dbg !133
  %11 = icmp eq i32 %10, 1, !dbg !133
  br i1 %11, label %12, label %15, !dbg !133

; <label>:12                                      ; preds = %9
  %13 = load i32* %x, align 4, !dbg !135
  %14 = add nsw i32 %13, 15, !dbg !135
  store i32 %14, i32* %x, align 4, !dbg !135
  br label %15, !dbg !135

; <label>:15                                      ; preds = %12, %9
  %16 = load i32* %x, align 4, !dbg !136
  %17 = icmp ne i32 %16, 28, !dbg !136
  br i1 %17, label %18, label %19, !dbg !136

; <label>:18                                      ; preds = %15
  br label %21, !dbg !136

; <label>:19                                      ; preds = %15
  %20 = call i32 (i8*, i8*, i32, i8*, ...)* bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([7 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([76 x i8]* @.str3, i32 0, i32 0), i32 16, i8* getel
  br label %21, !dbg !136

; <label>:21                                      ; preds = %19, %18
  %22 = load i32* %1, !dbg !137
  ret i32 %22, !dbg !137
}
...
!1 = metadata !{metadata !"/home/soha/git/tracerXMaster/tracerx/examples/jrExamples/testcomp_example.c", metadata !"/home/soha/git/tracerXMaster"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/soha/git/tracerXMaster//home/soha/git/tracerXMaster/tracerx/examples/jrExamples/testcomp_example.c]
...
!128 = metadata !{i32 7, i32 0, metadata !4, null}
!129 = metadata !{i32 8, i32 0, metadata !4, null} ; [ DW_TAG_imported_declaration ]
!130 = metadata !{i32 10, i32 0, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !4, i32 10, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster//home/soha/git/tracerXMaster/tracerx/examples/jrExamples/testcomp_example.c]
!132 = metadata !{i32 11, i32 0, metadata !131, null}
!133 = metadata !{i32 13, i32 0, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !4, i32 13, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster//home/soha/git/tracerXMaster/tracerx/examples/jrExamples/testcomp_example.c]
...
!139 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
...
!149 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!150 = metadata !{i32 27, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !38, metadata !149, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!152 = metadata !{i32 29, i32 0, metadata !37, null}
!153 = metadata !{i32 16, i32 0, metadata !154, null}
!154 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_range.c]
!155 = metadata !{i32 17, i32 0, metadata !154, null}
!156 = metadata !{i32 19, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_range.c]
!158 = metadata !{i32 22, i32 0, metadata !159, null}
!159 = metadata !{i32 786443, metadata !50, metadata !157, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_range.c]
!160 = metadata !{i32 25, i32 0, metadata !161, null}
!161 = metadata !{i32 786443, metadata !50, metadata !159, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_range.c]
!162 = metadata !{i32 26, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !50, metadata !161, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_range.c]
!164 = metadata !{i32 27, i32 0, metadata !163, null}
!165 = metadata !{i32 28, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !50, metadata !161, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/klee_range.c]
...
!179 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/memmove.c]
!180 = metadata !{i32 19, i32 0, metadata !181, null}
!181 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/memmove.c]
!182 = metadata !{i32 20, i32 0, metadata !183, null}
!183 = metadata !{i32 786443, metadata !83, metadata !181, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/memmove.c]
...
!187 = metadata !{i32 786443, metadata !83, metadata !181, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/soha/git/tracerXMaster/tracerx/runtime/Intrinsic/memmove.c]
